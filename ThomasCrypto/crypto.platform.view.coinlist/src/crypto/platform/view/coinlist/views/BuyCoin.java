...
public class BuyCoin extends TitleAreaDialog {
  CoinService directoryService = Activator.getCoinService();
  private static Logger log = Logger.getLogger(BuyCoin.class);
  ...
  public BuyCoin(Shell parentShell) {
    this(parentShell, "", "", holder);
    // TODO Auto-generated constructor stub
  }
  
  public BuyCoin(Shell shell, String name, String symbol, Long id) {
    super(shell);
    coinId = id;
    coinSymbol = symbol;
    coinName = name;
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    BuyCoin myBuyCoin = new BuyCoin(Display.getCurrent().getActiveShell());
    ...
    Label OrderLabel = new Label(composite, SWT.NONE);
    OrderLabel.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
    OrderLabel.setText("Order Volume:");
